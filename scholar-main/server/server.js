...
const context = ['/micro-scholar-main']
...
serverInstance.listen(PORT, function (err) {
  if (err) {
    ...
    console.log('Listen at ' + protocol + '://localhost:' + PORT + '/micro-scholar-main')
    console.log('Listen at ' + protocol + '://ky.qicoursezjh.com:' + PORT + '/micro-scholar-main')
  }
})
